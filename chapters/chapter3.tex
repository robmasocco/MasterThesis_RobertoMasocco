...
\end{itemize}
Una rappresentazione completa di nodi e topic relativi a questo package è mostrata in Figura \ref{fig:fctrl}, mentre i listati seguenti riassumono la struttura di ciascuno.
\newpage

\begin{lstlisting}[language=C++, caption=Definizione del nodo \emph{flight\_controller}.]
...
\begin{lstlisting}[language=C++, caption=Definizione del nodo \emph{control\_server}.]
...
\begin{lstlisting}[language=C++, caption=Definizione del nodo \emph{setpoint\_server}.]
...
\begin{lstlisting}[language=C++, caption=Definizione del nodo \emph{px4\_feedback\_listener}.]
