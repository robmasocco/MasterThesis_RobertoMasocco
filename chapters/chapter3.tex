...
Il calcolo dell'errore di posizionamento rispetto al centro della piazzola viene effettuato in metri, sapendo l'altitudine grazie all'odometria postata da PX4, la distanza focale della camera, la dimensione del landmark a terra ed una sua eventuale elevazione rispetto al suolo.
\clearpage
